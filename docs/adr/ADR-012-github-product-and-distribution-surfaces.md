...
**Status:** Accepted, 2026-09-09; conformance-distribution clarification added 2026-09-10; repository names updated 2026-09-10 when the product was renamed from Olive to Apron (naming clearance §1a). The topology, the boundary rule and the activation conditions are unchanged; only the names are. The private research repository was renamed accordingly on 2026-09-10.
